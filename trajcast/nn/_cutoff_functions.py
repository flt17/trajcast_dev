"""
Collection of cutoff functions. Not implemented yet but will be necessary to reproduce NequiP embedding
For now, taken from NequiP.
...
class PolynomialCutoff(torch.nn.Module):
    ...
    def __init__(self, rmax: float, p: float = 6):
